...
export default function Register() {
  ...
  let validationSchema= Yup.object(
    {
      ...
      password:Yup.string().required().matches(/^[A-Z][A-Za-z0-9!@#$%^&*()_-]{3,10}$/,"enter valid password"),
  ...
  async function dataRegister(objData){
    setloading(true);
    let {data}= await axios.post(`${Baseurl}/api/v1/auth/signup`,objData).catch((errors)=>{
